...
public class BCFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BCFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BCFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BCFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BCFDateTimeConverter dateTimeConverter = new BCFStandardDateTimeConverter();

    public BCFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BCFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BCFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BCFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BCFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BCFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
