...
public class BCFKPSPublicSoap
{
    ...
    public BCFKPSPublicSoap(){}

    public BCFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BCFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BCFExtendedSoapSerializationEnvelope envelope= new BCFExtendedSoapSerializationEnvelope(BCFExtendedSoapSerializationEnvelope.VER11);
